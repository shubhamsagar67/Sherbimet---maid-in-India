...
//                                                $language_id = $row['language_id'];
//                                               $query_city = mysqli_query($conn,"select * from tbl_city where language_id='{$language_id}'")or die(mysqli_error($conn));
//                            $row_city= mysqli_fetch_array($query_city);
//                            
//                                               
//                                                $language_name = $row_city['language_name'];
                                                ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="<?php echo $edit_link;?>?eid=<?php echo $language_id; ?>" class="btn btn-warning btn-xs"><i class="fa fa-pencil-alt"></i></a>
                                                    <button class="btn btn-danger btn-xs delete_record" type="button" name="submit"  value="<?php echo $language_id; ?>"><i class="fa fa-trash"></i></button>
                                                    </td>
