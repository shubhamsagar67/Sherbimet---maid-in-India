...
//                                                $city_name = $row_city['city_name'];
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="<?php echo $edit_link;?>?eid=<?php echo $city_id; ?>" class="btn btn-warning btn-xs"><i class="fa fa-pencil-alt"></i></a>
                                                    <button class="btn btn-danger btn-xs delete_record" type="button" name="submit"  value="<?php echo $city_id; ?>"><i class="fa fa-trash"></i></button>
                                                    </td>
