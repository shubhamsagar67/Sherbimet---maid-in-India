                                                ...
                                                $package_name = $row['package_name'];
                                                 $package_image = $row['package_image'];
                                                   ...
                                                   $subservice_id = $row['subservice_id'];
                                                            $query_1 = mysqli_query($conn,"select * from tbl_subservice where subservice_id='{$subservice_id}'")or die(mysqli_error($conn));
                            $row_1= mysqli_fetch_array($query_1);
                             $subservice_name = $row_1['subservice_name'];
                                                ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $package_name; ?></td>
                                                     ...
                                                     <td><i class="fa fa-rupee-sign"></i> <?php echo $row["package_price"]; ?></td>
                                                 <td><img src="images/package/<?php echo $package_image;?>" style="width: 50px;height: 50px;"></td>
                                                    <td><a href="<?php echo $edit_link;?>?eid=<?php echo $package_id; ?>" class="btn btn-warning btn-xs"><i class="fa fa-pencil-alt"></i></a>  <button class="btn btn-danger btn-xs delete_record" type="button" name="submit" data-order-id="<?php echo $package_id; ?>" value="<?php echo $package_id; ?>"><i class="fa fa-trash"></i></button></td>
