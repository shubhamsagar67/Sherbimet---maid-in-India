...
if (isset($_POST['update'])) {
    ...
    $id = mysqli_real_escape_string($conn, $_POST['city_id']);
    $city_name = mysqli_real_escape_string($conn, $_POST['city_name']);

    
     $query_check = mysqli_query($conn, "select lower(city_name) from $table where city_name=lower('{$city_name}') and NOT $primary_key = '{$id}'") or die(mysqli_error($conn));
  ...
  if($count>0)
  {
    ...
    $queryupdate = mysqli_query($conn, "update $table set city_name='{$city_name}',update_datetime='{$datetime}' where $primary_key='{$id}'") or die(mysqli_error($conn));
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-sm-3">
                      <!-- text input -->
                          <input type="hidden" class="form-control" name="city_id"  value="<?php echo $row_list['city_id']; ?>"  required>
                      <div class="form-group">
                        <label>City</label>
                        <input type="text" name="city_name" onkeyup ="Validatestring(this)" value="<?php echo $row_list['city_name']; ?>" class="form-control" placeholder="Enter City" required="">
                      </div>
                    </div>
